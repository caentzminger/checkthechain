...
def get_default_block_explorers() -> typing.Mapping[str, str]:
    return {
        ...
        'fraxtal_holesky': 'holesky.fraxscan.com',
        ...
        'base': 'basescan.org',
        'base_goerli': 'goerli.basescan.org',
        'base_sepolia': 'sepolia.basescan.org',
        'polygon_zkevm': 'zkevm.polygonscan.com',
        'polygon_zkevm_testnet': 'testnet-zkevm.polygonscan.com',
        'zksync_era': 'explorer.zksync.io',
        'zksync_era_sepolia': 'sepolia.explorer.zksync.io',
